...
- **Skutečné 3D modely vozů** (Three.js přes MapLibre CustomLayerInterface):
  low-poly autobus/**trolejbus** (typ z čísla linky — API ho nedává; trolejbus
  má sběrače), karoserie v barvě linky, střecha, okna, světla. Stojí na mapě,
  **naklání se s 3D perspektivou kamery** a **rotuje dle azimutu** (plynulá
  interpolace polohy i rotace v rAF). Zoom-kompenzace drží velikost ~konstantní
  na obrazovce. Vzpřímený štítek s číslem, tap → fly-to + zvýraznění.
- **Výstup:** vozy jezdí po mapě plynule jako v Uberu. *(ověřeno screenshoty
  z blízka i z dálky, ~15 vozů, rotace dle směru, trolejbusy se sběrači, 0 chyb)*

...
Analýza & plán dokončeny, stack potvrzen. **Fáze 0–2 hotové a ověřené** —
...
geolokace, LIVE pill). **Další krok: Fáze 3** (živé pohyblivé markery vozů —
největší „wow"). Viz [`docs/03`](docs/03-architecture-and-plan.md).
